...
public class ShowProductPic {
	
	@Autowired
	ProductServiceImpl productSvc;
	
	@GetMapping("/ShowProductPic")
	public void showPic
		(@PathParam("productId") String productId , @PathParam("productPhotoId") String productPhotoId, HttpServletRequest req , HttpServletResponse res)
		throws IOException{
